...
public class SituationFinanciereRepositoryImpl implements SituationFinanciereRepository {
    ...
    public void create(SituationFinanciere sf) {
        // Supposons les champs: patient_id, totalDesActes, totalePaye, credit, statut, observation
        // Le champ 'credit' est souvent calculé, mais peut être stocké pour la rapidité.
        ...
        try (Connection c = SessionFactory.getInstance().getConnection();
            ...
            ps.setDouble(4, sf.getCredit()); // Stockage du crédit calculé
