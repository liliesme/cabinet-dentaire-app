...
public class StaffRepositoryImpl implements StaffRepository {
    ...
    public void create(Staff s) {
        // Supposons des champs basiques pour le staff
        String sql = """
        ...
        try (Connection c = SessionFactory.getInstance().getConnection();
            ...
            ps.setString(4, s.getRole()); // Supposons que le rôle est un String ou stocké comme tel
            ps.setString(5, s.getTelephone());
            ps.setDate(6, Date.valueOf(s.getDateEmbauche())); // Date d'embauche
