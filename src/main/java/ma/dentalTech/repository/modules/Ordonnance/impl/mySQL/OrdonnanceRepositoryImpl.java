...
public class OrdonnanceRepositoryImpl implements OrdonnanceRepository {
    ...
    private String listToString(List<String> list) {
        ...
        return String.join("||", list); // Utilisation d'un séparateur peu commun (||)
    }
    ...
    public void create(Ordonnance o) {
        // Supposons les champs: patient_id, utilisateur_id, dateOrdonnance, lignesMedicaments (stocké en String)
